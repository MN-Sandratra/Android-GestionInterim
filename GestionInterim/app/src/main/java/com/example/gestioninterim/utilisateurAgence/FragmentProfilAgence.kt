...
import com.example.gestioninterim.services.ProfilAgenceService
...
class FragmentProfilAgence : Fragment() {
    ...
    fun launchServiceOffers(user : UtilisateurEmployeur) {
        ...
        val intent = Intent(requireContext(), ProfilAgenceService::class.java)
