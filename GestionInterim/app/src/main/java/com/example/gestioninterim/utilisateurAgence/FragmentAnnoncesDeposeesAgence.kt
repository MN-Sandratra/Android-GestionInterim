...
import com.example.gestioninterim.services.MissionAgenceService
...
class FragmentAnnoncesDeposeesAgence : Fragment(), FilterDialogCallbackEmployer{
    ...
    fun launchServiceOffers() {
        ...
        val intent = Intent(requireContext(), MissionAgenceService::class.java)
